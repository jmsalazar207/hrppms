<!--Modal Pop up for Approve-->
                                        <div class="modal fade" id="modalEdit<?=$Station_Code?>" role = "dialog">
                                                            ...
                                                            <div class="modal-body" id="Editmodalbody">
                                                                    <div class="row" hidden="true">
                                                                        ...
                                                                        <div class="col-md-8 text-left float-left">
                                                                            <input type="text" name="txtEditStationCode" class="form-control border-input" readonly="true" value="<?=$Station_Code?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-4 text-left float-left">
                                                                        ...
                                                                        <div class="col-md-8 text-left float-left">
                                                                            <input type="text" name="txtEditStationName" class="form-control border-input" value="<?=$Station_Name?>" style="text-transform: uppercase;">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-4 text-left float-left">
                                                                          Office Location/Official Station Description:
                                                                        </div>
                                                                        <div class="col-md-8 text-left float-left">
                                                                            <input type="text" name="txtEditStationDescription" class="form-control border-input" value="<?=$Station_Description?>" style="text-transform: uppercase;">
                                                                        </div>
                                                                    </div>                                                                                                           
                                                            </div>
                                            ...
                                            <div class="modal-dialog">
                                                <form name="frmAdd" method="POST">
                                                    <div class="modal-content" name = "divmodalAddNew" id="divmodalAddNew">
                                                        <div class="modal-header">
                                                            <button type="button" class="close btnCloseULadd" data-dismiss="modal">&times;</button>
                                                            <h4 class="modal-title text-left">Add New Office Location/Official Station Modal</h4>
                                                        </div>
                                                            <div class="modal-body" id="AddNewmodalbody">                                                 
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8 text-left float-left">
                                                                            <input type="text" name="txtAddStationName" class="form-control border-input" value="" style="text-transform: uppercase;" required="true">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="row">
                                                                        <div class="col-md-4 text-left float-left">
                                                                        ...
                                                                        <div class="col-md-8 text-left float-left">
                                                                            <input type="text" name="txtAddStationDescription" class="form-control border-input" value="" style="text-transform: uppercase;" required="true">
                                                                        </div>
                                                                    </div> 
...
<div class="modal fade" id="modalDeleteOLOS" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            ...
            <div class="modal-contenterror">
              ...
              <div class="modal-bodyerror">
                ...
                <h4>By clicking YES, you are going to delete the <i id="StationName"></i> in the list.</h4>
                    <div class="row">
                        <div class="col-md-4 text-left float-left"hidden>
                            OLOS Code:
                        </div>
                        <div class="col-md-8 text-left float-left">
                            <input type="hidden" name="txtDeleteOLOSCode" id="txtDeleteOLOSCode" class="form-control border-input" readonly="true">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 text-left float-left"hidden>
                        ...
                        <div class="col-md-8 text-left float-left" > 
                            <input type="hidden" name="txtDeleteOLOSName" id="txtDeleteOLOSName" class="form-control border-input" style="text-transform: uppercase;" readonly>
                        </div>
                    </div>        
              </div>
